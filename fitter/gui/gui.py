...
class Gui(object):
    ...
    def menuCommands(self):
        ...
        self.save = (lambda: Save(self.parent, self.parent.saveParams, "Save parameters and stats", 'dat'),
                     ...
                     lambda: Save(
                         self.parent, lambda name, ext: self.parent.fitter.plot(
    ...
    def bindCommands(self):
        ...
        self.parent.canvas.get_tk_widget().bind(
                "<C>", lambda event: self.parent.doAndPlot(lambda: self.parent.fitter.setplot(0), True))
        self.parent.canvas.get_tk_widget().bind(
                "<E>", lambda event: self.parent.doAndPlot(lambda: self.parent.fitter.setplot(1), True))
        self.parent.canvas.get_tk_widget().bind(
                "<A>", lambda event: self.parent.doAndPlot(lambda: self.parent.fitter.setplot(2), True))
        ...
        self.parent.canvas.get_tk_widget().bind(
                "<T>", lambda event: self.parent.doAndPlot(lambda: self.parent.fitter.toggle_area()))
        self.parent.canvas.get_tk_widget().bind(
                "<d>", lambda event: self.parent.doAndPlot(lambda: self.parent.load(self.parent.fitter.loadData)))
        self.parent.canvas.get_tk_widget().bind(
                "<b>", lambda event: self.parent.doAndPlot(lambda: self.parent.load(self.parent.fitter.loadBack)))
        self.parent.canvas.get_tk_widget().bind(
